...
func main() {
	...
	sourcesUrl := fmt.Sprintf("https://api.speedracelight.com/cdn/sources-with-title?title=Weapons&mediaType=movie&year=2025&episodeId=1&seasonId=1&tmdbId=%s&imdbId=tt26581740&enc=0&seed=%s&_t=%d", tmdbId, seed, t) // enc=0
	...
	fmt.Printf("Sources Response (enc=0): %s\n", string(body2))
}
