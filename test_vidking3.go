...
func main() {
	...
	sourcesUrl := fmt.Sprintf("https://api.speedracelight.com/cdn/sources-with-title?title=Weapons&mediaType=movie&year=2025&episodeId=1&seasonId=1&tmdbId=%s&imdbId=tt26581740&seed=%s&_t=%d", tmdbId, seed, t) // no enc
	...
	fmt.Printf("Sources Response (enc missing): %s\n", string(body2))
}
