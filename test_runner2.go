...
func main() {
	...
	sourcesUrl := fmt.Sprintf("https://api.speedracelight.com/cdn/sources-with-title?title=%s&mediaType=movie&year=2024&episodeId=1&seasonId=1&tmdbId=%s&imdbId=tt29731674&enc=2&seed=%s&_t=%d", encTitle, tmdbId, seed, t)
	...
	json.Indent(&prettyJSON, decData, "", "  ")
